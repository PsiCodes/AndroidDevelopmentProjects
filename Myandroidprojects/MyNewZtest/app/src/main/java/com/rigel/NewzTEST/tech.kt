...
class tech: Fragment() {
    ...
    override fun onCreateView(
        ...
        val v:View=inflater.inflate(R.layout.fragment_tech, container, false)

        val r1: RecyclerView? = v.findViewById(R.id.techfrag)
    ...
    private fun findnews() {
        val g=  apiutility.getMyApi().getMynews("in","technology",100)
