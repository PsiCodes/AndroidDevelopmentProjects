...
class Sports : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v:View=inflater.inflate(R.layout.fragment_sports, container, false)

        val r1: RecyclerView? = v.findViewById(R.id.sportsfrag)
    ...
    private fun findnews() {
        val g=  apiutility.getMyApi().getMynews("in","sports",100)
