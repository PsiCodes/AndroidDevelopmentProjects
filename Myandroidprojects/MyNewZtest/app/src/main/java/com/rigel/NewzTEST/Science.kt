...
class Science : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v:View=inflater.inflate(R.layout.fragment_science, container, false)

        val r1: RecyclerView? = v.findViewById(R.id.Sciencefrag)
