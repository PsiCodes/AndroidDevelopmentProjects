...
class Bussiness: Fragment() {
    ...
    override fun onCreateView(
        ...
        val v:View=inflater.inflate(R.layout.fragment_bussiness, container, false)

        val r1: RecyclerView? = v.findViewById(R.id.Bussinessfrag)
    ...
    private fun findnews() {
        val g=  apiutility.getMyApi().getMynews("in","business",100)
